      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold text-[#6A1E2C] leading-tight tracking-tight mb-4">
            Trusted Kongu Vellala Gounder Matrimony
          </h2>

          <p className="text-base sm:text-lg lg:text-xl text-[#222222]/85 leading-relaxed font-normal mb-6">
            Vivaaha Connect is exclusively dedicated to Kongu Vellala Gounder families. We help brides and grooms discover highly compatible life partners honoring traditional Kulam customs, verified professional backgrounds, and complete family privacy.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white border border-[#C89B63]/30 text-xs sm:text-sm font-bold text-[#6A1E2C] shadow-sm">
              <Users className="w-4 h-4 text-[#C89B63]" /> Kongu Vellala Gounder Only
            </span>
            <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white border border-[#C89B63]/30 text-xs sm:text-sm font-bold text-[#6A1E2C] shadow-sm">
