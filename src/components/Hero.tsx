        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-[17px] text-[#222222]/80 leading-relaxed mb-4 max-w-[520px] mx-auto lg:mx-0">
              Exclusive matrimony platform dedicated to the Kongu Vellala Gounder community across Tamil Nadu and worldwide with trusted connections and Kulam-compatible matchmaking.
            </p>
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#F8E8DA]/80 border border-[#C89B63]/30 backdrop-blur-sm self-center lg:self-start mb-5 text-xs sm:text-sm font-semibold text-[#6A1E2C]">
              ...
              <span>Dedicated Exclusively to Kongu Vellala Gounder Community</span>
            </div>
          ...
          >
            ...
            <div className="rounded-3xl bg-white/95 border border-[#C89B63]/30 shadow-xl p-5 sm:p-6 backdrop-blur-lg relative overflow-hidden">
              ...
              <p className="text-xs sm:text-sm text-[#222222]/80 leading-relaxed mb-4">
                {activeTab === 'bride'
                  ? 'Register Kongu Vellala Gounder bride profiles with complete confidentiality. Connect with educated, well-settled grooms from compatible Kulams.'
                  : 'Register Kongu Vellala Gounder groom profiles with complete confidentiality. Connect with educated, well-settled brides from compatible Kulams.'}
              </p>
